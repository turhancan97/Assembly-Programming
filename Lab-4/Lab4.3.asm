list P=18F45K22, r=dec, n=0
     ...
     ;   /* Turn off all code protection */
	    ...
	    COUNTER EQU 0X00
	    MOVLW 0X06 ; enter here how many character you have
	    MOVWF COUNTER ; for looping
	    LFSR 0,0X10 ; Pointer for loc 0x10
	    LFSR 1,0X25 ; Pointer for loc 0x25
	    
L1	    MOVFF POSTINC0,POSTDEC1 ; Move loc 10h (and increase) to loc 25 (and decrease)	 
	    DECF COUNTER,F
	    BNZ L1
	    ...
	    MOVWF COUNTER
	    LFSR 0,0X10 ; Pointer for loc 0x10
	    LFSR 1,0X20 ; Pointer for loc 0x20
	    
L2	    MOVFF POSTINC1,POSTINC0 ; Move loc 20h to loc 10 and increase both of them	 
	    DECF COUNTER,F
	    BNZ L2
	    END
